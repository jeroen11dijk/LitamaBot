...
public class GameTest {
    ...
    void mateIn1Red() {
        ...
        Board board = new Board("0000023041000000000000000");
    ...
    void mateIn2RedBlueTurn() {
        ...
        Board board = new Board("0200003041000000000000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 3; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn3Red() {
        ...
        Color turn = Color.RED;
        Board board = new Board("0200003001004000000000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 4; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn4RedBlueTurn() {
        ...
        Card middle = Card.MANTIS;
        Color turn = Color.BLUE;
        Board board = new Board("0201003000004000000000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 5; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn5Red() {
        ...
        Card middle = Card.EEL;
        Color turn = Color.RED;
        Board board = new Board("0201003000000000400000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 6; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn6RedBlueTurn() {
        ...
        Card middle = Card.RABBIT;
        Color turn = Color.BLUE;
        Board board = new Board("2001003000000000400000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 7; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn7Red() {
        ...
        Card middle = Card.MANTIS;
        Color turn = Color.RED;
        Board board = new Board("2001000000003000400000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 8; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn8RedBlueTurn() {
        ...
        Card middle = Card.EEL;
        Color turn = Color.BLUE;
        Board board = new Board("2000000010003000400000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 9; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn9Red() {
        ...
        Color turn = Color.RED;
        Board board = new Board("2000000010000300400000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 10; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn10RedBlueTurn() {
        ...
        Card middle = Card.MANTIS;
        Color turn = Color.BLUE;
        Board board = new Board("0200000010000300400000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 11; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
    ...
    void mateIn11Red() {
        ...
        Card middle = Card.RABBIT;
        Color turn = Color.RED;
        Board board = new Board("0200000010000000430000000");
        Game game = new Game(board, turn, Color.RED, red, blue, middle);
        for (int i = 1; i < 12; i++) {
            game = game.applyMove(game.negamaxRoot(10));
        }
